...
class TestPricingMethods(unittest.TestCase):
    ...
    def test_martingale_property(self):
        ...
        ref_errors = (
            ...
            ( 7.5891607812887215e-11, 2.0799355032412960e-04, 1.5434289119058819e-02, 2.0168759827188243e-05, ),
            ( 2.0111106640019473e-07, 9.4620512875760870e-03, 5.8127638102258530e-02, 1.0598903143438364e-05, ),
            ( 1.4835285185495670e-08, 1.1517828637251056e-03, 8.0823181086123352e-02, 2.0116491925364909e-05, ),
        )
        print('')
